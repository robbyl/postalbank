...
;
YUI.add('moodle-theme_synergy_bootstrap-bootstrap', function (Y, NAME) {

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@namespace Moodle
@module theme_synergy_bootstrap-bootstrap
**/

/**
The Moodle Bootstrap theme's bootstrap JavaScript

@class Moodle.theme_synergy_bootstrap.bootstrap
@uses node
@uses selector-css3
@constructor
**/
var CSS = {
    ...
    NS = Y.namespace('Moodle.theme_synergy_bootstrap.bootstrap');
